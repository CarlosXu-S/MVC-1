...
},{"process":"TtZm"}],"U+s5":[function(require,module,exports) {
"use strict";
...
},{"jquery":"juYr","./app1.css":"1AQo"}],"vZ5o":[function(require,module,exports) {
"use strict";
...
$tabBar.on('click', 'li', function (e) {
  //通过监听父元素，来监听子元素，这就是事件委托
  var $li = (0, _jquery.default)(e.currentTarget);
  $li.addClass('selected').siblings().removeClass('selected');
  var index = $li.index(); //通过index()方法知道排第几个

  $tabContent.children().eq(index).addClass('active') //eq()就是等于第几个
  .siblings().removeClass('active');
});
$tabBar.children().eq(0).trigger('click');
},{"jquery":"juYr","./app2.css":"1AQo"}],"y8lT":[function(require,module,exports) {
"use strict";
...
//# sourceMappingURL=main.e398d10e.js.map